...
from common.datebase import Database
...
class Model(metaclass=ABCMeta):
    ...
    @classmethod
    def find_many_by(cls: Type[T], attribute: str, value: Union[str, Dict]) -> List[T]:  # Next step in this can be done like done in line 24-25
